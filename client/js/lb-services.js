  ...
  ['LoopBackResource', 'LoopBackAuth', '$injector', function(Resource, LoopBackAuth, $injector) {
    var R = Resource(
      ...
      { 'id': '@id' },
      {
        ...
        /**
         * @ngdoc method
         * @name lbServices.Period#createMany
         * @methodOf lbServices.Period
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Period#createChangeStream
         * @methodOf lbServices.Period
         *
         * @description
         *
         ...
         */
        "createChangeStream": {
          url: urlBase + "/periods/change-stream",
          method: "POST"
        },
      }
    );
  ...
  ['LoopBackResource', 'LoopBackAuth', '$injector', function(Resource, LoopBackAuth, $injector) {
    var R = Resource(
      ...
      { 'id': '@id' },
      {
        ...
        // INTERNAL. Use User.users.findById() instead.
        "prototype$__findById__users": {
          params: {
          'fk': '@fk'
          },
          url: urlBase + "/users/:id/users/:fk",
          method: "GET"
        },

        // INTERNAL. Use User.users.destroyById() instead.
        ...
        // INTERNAL. Use User.users.updateById() instead.
        ...
        // INTERNAL. Use User.user() instead.
        "prototype$__get__user": {
          url: urlBase + "/users/:id/user",
          method: "GET"
        },

        // INTERNAL. Use User.users() instead.
        "prototype$__get__users": {
          isArray: true,
          url: urlBase + "/users/:id/users",
          method: "GET"
        },

        // INTERNAL. Use User.users.create() instead.
        "prototype$__create__users": {
          url: urlBase + "/users/:id/users",
          method: "POST"
        },

        // INTERNAL. Use User.users.destroyAll() instead.
        "prototype$__delete__users": {
          url: urlBase + "/users/:id/users",
          method: "DELETE"
        },

        // INTERNAL. Use User.users.count() instead.
        "prototype$__count__users": {
          url: urlBase + "/users/:id/users/count",
          method: "GET"
        },
        ...
        // INTERNAL. Use User.users.createMany() instead.
        "::createMany::user::users": {
          isArray: true,
          url: urlBase + "/users/:id/users",
          method: "POST"
        },
    ...
    */
    ...
    /**
     * @ngdoc object
     * @name lbServices.User.users
     * @header lbServices.User.users
     * @object
     * @description
     *
     * The object `User.users` groups methods
     * manipulating `User` instances related to `User`.
     *
     * Call {@link lbServices.User#users User.users()}
     ...
     */
        ...
        R.users = function() {
          ...
          var action = TargetResource["::get::user::users"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.User.users#count
         * @methodOf lbServices.User.users
         *
         * @description
         *
         * Counts users of user.
         *
         * @param {Object=} parameters Request parameters.
         *
         *  - `id` – `{*}` - User id
        ...
        R.users.count = function() {
          var TargetResource = $injector.get("User");
          var action = TargetResource["::count::user::users"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.User.users#create
         * @methodOf lbServices.User.users
         *
         * @description
         *
        ...
        R.users.create = function() {
          var TargetResource = $injector.get("User");
          var action = TargetResource["::create::user::users"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.User.users#createMany
         * @methodOf lbServices.User.users
         *
         * @description
         *
        ...
        R.users.createMany = function() {
          var TargetResource = $injector.get("User");
          var action = TargetResource["::createMany::user::users"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.User.users#destroyAll
         * @methodOf lbServices.User.users
         *
         * @description
         *
        ...
        R.users.destroyAll = function() {
          var TargetResource = $injector.get("User");
          var action = TargetResource["::delete::user::users"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.User.users#destroyById
         * @methodOf lbServices.User.users
         *
         * @description
         *
        ...
        R.users.destroyById = function() {
          var TargetResource = $injector.get("User");
          var action = TargetResource["::destroyById::user::users"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.User.users#findById
         * @methodOf lbServices.User.users
         *
         * @description
         *
        ...
        R.users.findById = function() {
          var TargetResource = $injector.get("User");
          var action = TargetResource["::findById::user::users"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.User.users#updateById
         * @methodOf lbServices.User.users
         *
         * @description
         *
        ...
        R.users.updateById = function() {
          var TargetResource = $injector.get("User");
          var action = TargetResource["::updateById::user::users"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.User#user
         * @methodOf lbServices.User
         *
         * @description
         *
        ...
        R.user = function() {
          var TargetResource = $injector.get("User");
          var action = TargetResource["::get::user::user"];
          return action.apply(R, arguments);
        };
